...
import { ArrowLeft, MapPin, BookOpen, Lightbulb, Quote, GraduationCap } from "lucide-react";
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-card rounded-xl p-8 border border-border shadow-md"
          >
          ...
          >
            ...
            <ul className="space-y-4">
              {philosopher.mainThoughts.map((thought, i) => (
                <li key={i} className="flex items-start gap-3 font-body text-foreground">
                  <span className="w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center flex-shrink-0 text-xs font-semibold mt-0.5">
                    {i + 1}
                  </span>
